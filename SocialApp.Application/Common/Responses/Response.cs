...
namespace SocialApp.Application.Common.Responses
{
    public class Response<T>
    {
        public static Response<T> Fail(string title, string message, T data = default) => new Response<T>(false, data, Error.Create(title, message));
        public static Response<T> Fail(Error error, T data = default) => new Response<T>(false, data, error);
        public static Response<T> Success(T data) => new Response<T>(true, data, null);
